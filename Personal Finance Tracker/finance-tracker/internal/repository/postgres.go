...
func (r *PostgresRepository) GetCategoriesByUserID(userID int) ([]models.Category, error) {
	query := `
...
func (r *PostgresRepository) GetCategoryByID(id int) (*models.Category, error) {
	query := `
		SELECT id, user_id, name, description, type, created_at
...
// Transaction methods
func (r *PostgresRepository) CreateTransaction(transaction *models.Transaction) error {
	query := `
...
func (r *PostgresRepository) GetTransactionsByUserID(userID int) ([]models.Transaction, error) {
	query := `
...
func (r *PostgresRepository) GetTransactionByID(id int) (*models.Transaction, error) {
	query := `
...
func (r *PostgresRepository) GetTransactionsByPeriod(userID int, start, end time.Time) ([]models.Transaction, error) {
	query := `
        SELECT t.id, t.user_id, t.category_id, t.account_id, t.amount, t.description, t.date, t.type, t.created_at
        FROM transactions t
	...
	rows, err := r.db.Query(context.Background(), query, userID, start, end)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (r *PostgresRepository) GetSessionByToken(token string) (*models.Session, error) {
	query := `
	...
	err := r.db.QueryRow(context.Background(), query, token, time.Now()).Scan(
		&session.ID,
		&session.UserID,
		&session.Token,
		&session.ExpiresAt,
...
func (r *PostgresRepository) GetCurrencyByID(id int) (*models.Currency, error) {
...
func (r *PostgresRepository) GetTransactionsByAccountID(accountID int) ([]models.Transaction, error) {
	query := `
        SELECT t.id, t.user_id, t.category_id, t.account_id, t.amount, t.description, t.date, t.type, t.created_at
        FROM transactions t
